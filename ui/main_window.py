...
class SCDToolkit(QMainWindow):
    ...
    def create_library_panel(self):
        ...
        self.folder_list.verticalScrollBar().setSingleStep(1)
        ...
        self.file_list.verticalScrollBar().setSingleStep(1)
        ...
        self.kh_rando_file_list.verticalScrollBar().setSingleStep(1)
